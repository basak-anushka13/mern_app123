...
const parseCSV = (content: string): ListItem[] => {
  ...
  const firstNameIndex = headers.findIndex(
    (h) =>
      h.includes("firstname") || h.includes("first_name") || h.includes("name"),
  );
  const phoneIndex = headers.findIndex(
    (h) => h.includes("phone") || h.includes("mobile") || h.includes("number"),
  );
  const notesIndex = headers.findIndex(
    (h) => h.includes("notes") || h.includes("note") || h.includes("comment"),
  );
      ...
      items = [
        {
          ...
          firstName: "John",
          phone: "+1234567890",
          notes: "Demo contact 1",
        },
        {
          id: "demo-2",
          firstName: "Jane",
          phone: "+1234567891",
          notes: "Demo contact 2",
        },
        {
          id: "demo-3",
          firstName: "Bob",
          phone: "+1234567892",
          notes: "Demo contact 3",
        },
        {
          id: "demo-4",
          firstName: "Alice",
          phone: "+1234567893",
          notes: "Demo contact 4",
        },
        {
          id: "demo-5",
          firstName: "Charlie",
          phone: "+1234567894",
          notes: "Demo contact 5",
        },
        {
          id: "demo-6",
          firstName: "Diana",
          phone: "+1234567895",
          notes: "Demo contact 6",
        },
        {
          id: "demo-7",
          firstName: "Eva",
          phone: "+1234567896",
          notes: "Demo contact 7",
        },
        {
          id: "demo-8",
          firstName: "Frank",
          phone: "+1234567897",
          notes: "Demo contact 8",
        },
        {
          id: "demo-9",
          firstName: "Grace",
          phone: "+1234567898",
          notes: "Demo contact 9",
        },
        {
          id: "demo-10",
          firstName: "Henry",
          phone: "+1234567899",
          notes: "Demo contact 10",
        },
      ];
    }
